...
export const generateInvoicesQuery = (
    ...
    const queryFields = [...(isAdmin ? adminFields : []), { field: 'b.InvoiceDt', label: 'InvoiceDate' }, { field: 'b.ShipFromID', label: 'ShipFromID' }, { field: 'b.ShippingDt', label: 'ShippingDate' }, { field: 'b.CompletedDt', label: 'CompletedDate' }, { field: 'b.BuySellNo', label: 'InvoiceNo' }, { field: 'b.UserID', label: 'SalesRep' }, { field: 'c.CompanyNm', label: 'Client' }, { field: 'b.OrderDt', label: 'OrderDate' }, { field: 'b.TradeType', label: 'ProductType' }, { field: 'v.CompanyNm', label: 'Supplier' }, { field: 'w.SWeightUOM', label: 'QtyUom' }, { field: 'w.SPrice', label: 'PriceSale' }, { field: 'w.SPriceUOM', label: 'PriceUomSale' }, { field: 'w.SCurrencyCd', label: 'CurrencySale' }, { field: 'b.DueDt', label: 'DueDate' }, { field: 'b.Commission1', label: 'Commission' }, { field: 'b.AltCoEmail', label: 'ContactPoint' }];
